      ...
      <article v-for="barcode in filteredBarcodes" :key="barcode.id"
        ...
        <div class="barcode-content">
          <div class="barcode-title-row">
            <h3 class="md-typescale-title-medium md-m-0">{{ getBarcodeDisplayTitle(barcode.barcode_type) }}</h3>
            <div class="barcode-badges md-flex md-gap-2 md-flex-wrap">
              ...
              <md-assist-chip v-if="barcode.owner" aria-label="Owner" data-aria-label="Owner" has-icon>
