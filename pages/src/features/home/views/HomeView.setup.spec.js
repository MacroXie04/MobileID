...
vi.mock('@school/components/header/Header.vue', () => ({
  default: { name: 'Header', template: '<div />' },
}));
vi.mock('@school/components/user-profile/UserProfile.vue', () => ({
  default: { name: 'UserProfile', template: '<div />' },
}));
vi.mock('@school/components/barcode-display/BarcodeDisplay.vue', () => ({
  default: { name: 'BarcodeDisplay', template: '<div />' },
}));
vi.mock('@school/components/grid-menu/GridMenu.vue', () => ({
