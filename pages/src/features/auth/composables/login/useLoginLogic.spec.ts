...
const { mockEstablishSession, mockLogin, mockSetUserInfo } = vi.hoisted(() => ({
  mockEstablishSession: vi.fn(),
  mockLogin: vi.fn(),
  mockSetUserInfo: vi.fn(),
}));
vi.mock('@auth', () => ({
  login: (...args: unknown[]) => mockLogin(...args),
  establishAuthenticatedSession: (...args: unknown[]) => mockEstablishSession(...args),
