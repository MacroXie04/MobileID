...
export function useBarcodesListLogic() {
  ...
  function getBarcodeDisplayTitle(barcodeType: string) {
    switch (barcodeType) {
      case 'DynamicBarcode':
  ...
  function getBarcodeTypeLabel(type: string) {
    if (type === 'DynamicBarcode') return 'Dynamic';
    return 'Static';
  }

  function getProfileLabel(barcode: Barcode) {
  ...
  function getProfileTooltip(barcode: Barcode) {
  ...
  function getBarcodeDisplayId(barcode: Barcode) {
