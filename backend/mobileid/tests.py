...
class AccountSecurityTest(BaseTestCase):
    ...
    def test_account_locking(self):
        ...
        self.user_profile.locked_until = timezone.now() + timedelta(minutes=settings.ACCOUNT_LOCKOUT_DURATION)
        self.user_profile.save()
    ...
    def test_account_unlocking(self):
        ...
        # Lock account
        self.user_profile.is_locked = True
        self.user_profile.locked_until = timezone.now() - timedelta(minutes=1)  # Past time
        self.user_profile.save()
...
class PerformanceTest(BaseTestCase):
    ...
    def test_bulk_usage_creation(self):
        ...
        # Verify creation success
        self.assertEqual(BarcodeUsage.objects.count(), 51)  # Including 1 created in setUp
...
class SecurityTest(BaseTestCase):
    ...
    def test_user_profile_data_isolation(self):
        ...
        self.assertNotEqual(self.user_profile.information_id, other_profile.information_id)
