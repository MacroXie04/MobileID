<template>
  <div class="container mt-5 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card p-4 shadow-sm" style="max-width:800px; width:100%;">
      <h3 class="text-center mb-4 fw-semibold">Register</h3>
          ...
          <div class="avatar-section">
            ...
            <div class="cropper-section">
              <div class="cropper-container" ref="cropperContainer">
                <div class="crop-area" ref="cropArea">
                  <div class="crop-placeholder" ref="cropPlaceholder">
                    <i class="fas fa-cloud-upload-alt mb-2 d-block" style="font-size:2rem;"></i>
                    Click "Select Avatar" to upload & crop
                  </div>
                  <img ref="cropperImage" style="display:none;" alt="">
                </div>
                <div class="crop-controls" ref="cropControls">
                  <div class="d-flex gap-2 justify-content-between align-items-center">
                    <small class="text-muted">Drag to move • Scroll to zoom</small>
                    <div class="d-flex gap-2">
                      <button type="button" class="btn btn-outline-secondary btn-sm" @click="resetCrop">
                        <i class="fas fa-undo"></i> Reset
                      </button>
                      <button type="button" class="btn btn-primary btn-sm" ref="applyCropBtn" @click="applyCrop">
              ...
              <div class="mt-2">
                ...
                <button type="button" class="btn btn-outline-primary" ref="selectImageBtn" @click="selectImage">
                  <i class="fas fa-image"></i> Select Avatar
                </button>
                <button type="button" class="btn btn-outline-danger ms-2" ref="removeImageBtn" style="display:none;" @click="removeImage">
                ...
                <small class="text-muted d-block mt-1">JPEG/PNG • Max 5 MB • Resized 128×128 • Optional</small>
              </div>
            </div>
          </div>
        </div>
...
// Methods
const getAvatarSrc = () => {
  if (formData.value.user_profile_img_base64) {
    return `data:image/png;base64,${formData.value.user_profile_img_base64}`;
  }
...
const applyCrop = () => {
  ...
  formData.value.user_profile_img_base64 = dataURL.split(',')[1];
...
const removeImage = () => {
  formData.value.user_profile_img_base64 = '';
  fileInput.value.value = '';
