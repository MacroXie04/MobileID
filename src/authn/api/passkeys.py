...
def passkey_registration_options(request):
    ...
    try:
        ...
        user_entity = webauthn.types.User(
            ...
            display_name=(
                getattr(user.userprofile, "name", user.username)
...
def passkey_registration_verify(request):
    ...
    try:
        ...
        if not credential:
            return Response(
                {"success": False, "message": "No credential data provided"}, status=400
            )
        ...
        if not expected_challenge:
            return Response(
                {"success": False, "message": "No registration challenge found"},
                status=400,
            )
        ...
        return Response(
            {"success": False, "message": "Passkey verification failed"}, status=400
        )

    except Exception as e:
        return Response(
            {"success": False, "message": f"Failed to verify registration: {str(e)}"},
            status=500,
        )
...
def passkey_authentication_verify(request):
    ...
    try:
        ...
        if not expected_challenge:
            return Response(
                {"success": False, "message": "No authentication challenge found"},
                status=400,
            )
        ...
        if not credential_id:
            return Response(
                {"success": False, "message": "No credential ID provided"}, status=400
            )
        ...
        try:
            ...
            try:
                ...
                return Response(
                    {"success": False, "message": "Passkey not found"}, status=400
                )
        ...
        return Response(
            {"success": False, "message": f"Failed to verify authentication: {str(e)}"},
            status=500,
        )
...
def passkey_list(request):
    ...
    try:
        ...
        return Response({"success": True, "passkeys": passkeys_data})

    except Exception as e:
        return Response(
            {"success": False, "message": f"Failed to list passkeys: {str(e)}"},
            status=500,
        )
...
def passkey_delete(request, passkey_id):
    ...
    try:
        ...
        return Response({"success": False, "message": "Passkey not found"}, status=404)
    except Exception as e:
        return Response(
            {"success": False, "message": f"Failed to delete passkey: {str(e)}"},
            status=500,
        )
