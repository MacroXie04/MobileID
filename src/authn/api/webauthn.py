...
class RSAEncryptedLoginSerializer(TokenObtainPairSerializer):
    """
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            logger.warning("Login attempt with invalid encrypted password format: %s", str(e))
