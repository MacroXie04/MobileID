...
class AdminSessionExpiryMiddleware:
    ...
    Admin sessions expire after ADMIN_SESSION_COOKIE_AGE seconds (default 2 hours)  # noqa: E501
    ...
    def __call__(self, request):
        ...
        if request.path.startswith(self.admin_path):
            if hasattr(request, "session"):
                # Set session expiry to admin-specific duration (2 hours default)  # noqa: E501
